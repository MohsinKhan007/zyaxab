...
test("Form displays an empty message if the email or password is blank ", () => {
    ...
    expect(screen.getByTestId("errorMsg")).toHaveTextContent("Email or Password cannot be empty")
})
